/****************************************************************************
** Meta object code from reading C++ file 'double_spin_box_delegate.hpp'
**
...
#include "../../../../src/graph_creator_rviz_plugin/src/double_spin_box_delegate.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'double_spin_box_delegate.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject DoubleSpinBoxDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_DoubleSpinBoxDelegate.data,
    qt_meta_data_DoubleSpinBoxDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
