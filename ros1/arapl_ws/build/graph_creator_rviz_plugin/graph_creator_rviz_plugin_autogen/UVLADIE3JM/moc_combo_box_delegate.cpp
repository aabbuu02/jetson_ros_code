/****************************************************************************
** Meta object code from reading C++ file 'combo_box_delegate.hpp'
**
...
#include "../../../../src/graph_creator_rviz_plugin/src/combo_box_delegate.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'combo_box_delegate.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject ComboBoxItemDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ComboBoxItemDelegate.data,
    qt_meta_data_ComboBoxItemDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
