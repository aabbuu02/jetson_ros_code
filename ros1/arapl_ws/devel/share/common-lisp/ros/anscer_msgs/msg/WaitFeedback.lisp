...
(cl:defmethod cl:initialize-instance :after ((m <WaitFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaitFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name anscer_msgs-msg:<WaitFeedback> is deprecated: use anscer_msgs-msg:WaitFeedback instead.")))

(cl:ensure-generic-function 'wait_feedback-val :lambda-list '(m))
(cl:defmethod wait_feedback-val ((m <WaitFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anscer_msgs-msg:wait_feedback-val is deprecated.  Use anscer_msgs-msg:wait_feedback instead.")
  (wait_feedback m))
