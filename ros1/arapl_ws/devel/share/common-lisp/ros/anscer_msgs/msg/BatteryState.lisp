...
(cl:defmethod cl:initialize-instance :after ((m <BatteryState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BatteryState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name anscer_msgs-msg:<BatteryState> is deprecated: use anscer_msgs-msg:BatteryState instead.")))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anscer_msgs-msg:voltage-val is deprecated.  Use anscer_msgs-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <BatteryState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anscer_msgs-msg:current-val is deprecated.  Use anscer_msgs-msg:current instead.")
  (current m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BatteryState>)))
  ...
  (cl:format cl:nil "#mission status~%float32 voltage~%float32 current~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BatteryState)))
  "Returns full string definition for message of type 'BatteryState"
  (cl:format cl:nil "#mission status~%float32 voltage~%float32 current~%~%~%"))
