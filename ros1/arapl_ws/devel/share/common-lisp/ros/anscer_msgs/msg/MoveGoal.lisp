...
(cl:defmethod cl:initialize-instance :after ((m <MoveGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name anscer_msgs-msg:<MoveGoal> is deprecated: use anscer_msgs-msg:MoveGoal instead.")))

(cl:ensure-generic-function 'source_id-val :lambda-list '(m))
(cl:defmethod source_id-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anscer_msgs-msg:source_id-val is deprecated.  Use anscer_msgs-msg:source_id instead.")
  (source_id m))

(cl:ensure-generic-function 'target_id-val :lambda-list '(m))
(cl:defmethod target_id-val ((m <MoveGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader anscer_msgs-msg:target_id-val is deprecated.  Use anscer_msgs-msg:target_id instead.")
  (target_id m))
