...
class MissionAnalyticsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MissionAnalyticsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MissionAnalyticsRequest
    let len;
    let data = new MissionAnalyticsRequest(null);
  ...
  static datatype() {
    ...
    return 'anscer_msgs/MissionAnalyticsRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionAnalyticsRequest(null);
...
class MissionAnalyticsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MissionAnalyticsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MissionAnalyticsResponse
    let len;
    let data = new MissionAnalyticsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionAnalyticsResponse(null);
...
module.exports = {
  Request: MissionAnalyticsRequest,
  Response: MissionAnalyticsResponse,
  md5sum() { return '08b960482269c6ce2305b1dc4350baa3'; },
  datatype() { return 'anscer_msgs/MissionAnalytics'; }
};
