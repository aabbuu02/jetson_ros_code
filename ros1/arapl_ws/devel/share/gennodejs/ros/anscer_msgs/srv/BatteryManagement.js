...
class BatteryManagementRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BatteryManagementRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BatteryManagementRequest
    let len;
    let data = new BatteryManagementRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BatteryManagementRequest(null);
...
class BatteryManagementResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.id = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BatteryManagementResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BatteryManagementResponse
    let len;
    let data = new BatteryManagementResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new BatteryManagementResponse(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
...
module.exports = {
  Request: BatteryManagementRequest,
  Response: BatteryManagementResponse,
  md5sum() { return '2fdc892b1cd61ba46702fac69928aa1a'; },
  datatype() { return 'anscer_msgs/BatteryManagement'; }
};
