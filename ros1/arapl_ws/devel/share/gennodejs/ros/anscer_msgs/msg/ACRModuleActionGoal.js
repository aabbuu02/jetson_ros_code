...
class ACRModuleActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ACRModuleGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ACRModuleActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ACRModuleGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ACRModuleGoal()
    }
...
module.exports = ACRModuleActionGoal;
