...
class ACRModuleActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ACRModuleFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ACRModuleFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ACRModuleActionFeedback(null);
    ...
    data.feedback = ACRModuleFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ACRModuleActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ACRModuleFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ACRModuleFeedback()
    }
...
module.exports = ACRModuleActionFeedback;
