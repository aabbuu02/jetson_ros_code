...
class ErrorActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ErrorFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ErrorFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ErrorActionFeedback(null);
    ...
    data.feedback = ErrorFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ErrorActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ErrorFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ErrorFeedback()
    }
...
module.exports = ErrorActionFeedback;
