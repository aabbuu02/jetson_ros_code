...
"""autogenerated by genpy from graph_msgs/Graph.msg. Do not edit."""
import codecs
import sys
...
class Graph(genpy.Message):
  _md5sum = "0310af2f1693ece9ce205cea29e160ca"
  _type = "graph_msgs/Graph"
...
Pose[] poses
"""
  __slots__ = ['header','meta_data','vertices','edges','properties']
  _slot_types = ['std_msgs/Header','graph_msgs/GraphMetaData','graph_msgs/Vertex[]','graph_msgs/Edge[]','graph_msgs/Property[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,meta_data,vertices,edges,properties
    ...
    if args or kwds:
      ...
      if self.meta_data is None:
        self.meta_data = graph_msgs.msg.GraphMetaData()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3I().pack(_x.meta_data.header.seq, _x.meta_data.header.stamp.secs, _x.meta_data.header.stamp.nsecs))
      _x = self.meta_data.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.meta_data.graph_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B2I().pack(_x.meta_data.graph_type, _x.meta_data.number_of_vertices, _x.meta_data.number_of_edges))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.meta_data.header.seq, _x.meta_data.header.stamp.secs, _x.meta_data.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.meta_data.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.meta_data.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.meta_data.graph_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.meta_data.graph_name = str[start:end]
      _x = self
      start = end
      end += 9
      (_x.meta_data.graph_type, _x.meta_data.number_of_vertices, _x.meta_data.number_of_edges,) = _get_struct_B2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.vertices = []
