...
"""autogenerated by genpy from graph_msgs/SaveGraphRequest.msg. Do not edit."""
import codecs
import sys
...
class SaveGraphRequest(genpy.Message):
  _md5sum = "dd7a82666ae251d98fe8ab14eece8e36"
  _type = "graph_msgs/SaveGraphRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Either use absolute path to save the graph file like /path/to/save/ or
...
"""
  __slots__ = ['graph_file_name','save_graph_url']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       graph_file_name,save_graph_url
    ...
    if args or kwds:
      ...
      if self.graph_file_name is None:
        self.graph_file_name = ''
      if self.save_graph_url is None:
        self.save_graph_url = ''
    else:
      self.graph_file_name = ''
      self.save_graph_url = ''
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.graph_file_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.save_graph_url
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.graph_file_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.graph_file_name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.save_graph_url = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.save_graph_url = str[start:end]
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from graph_msgs/SaveGraphResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SaveGraphResponse(genpy.Message):
  _md5sum = "115c599f6c1b91f721584f6e8165bdc7"
  _type = "graph_msgs/SaveGraphResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class SaveGraph(object):
  _type          = 'graph_msgs/SaveGraph'
  _md5sum = '70cd2cf58e0678fd28ff2029ea82cfd1'
