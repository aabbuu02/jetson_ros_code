...
"""autogenerated by genpy from anscer_msgs/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "9671ec5701f04f6d39e087089793ee95"
  _type = "anscer_msgs/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','anscer_msgs/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = anscer_msgs.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = anscer_msgs.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.move_feedback
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.move_feedback,) = _get_struct_B().unpack(str[start:end])
      self.feedback.move_feedback = bool(self.feedback.move_feedback)
      return self
