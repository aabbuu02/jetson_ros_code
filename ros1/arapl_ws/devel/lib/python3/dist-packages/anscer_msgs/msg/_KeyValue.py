...
"""autogenerated by genpy from anscer_msgs/KeyValue.msg. Do not edit."""
import codecs
import sys
...
class KeyValue(genpy.Message):
  _md5sum = "0366bc3220232a9a18c5cc0865090e86"
  _type = "anscer_msgs/KeyValue"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string key			#Label of the value
string value		#Value to track
string unit
float32 errorlevel			#Errorlevel of the value"""
  __slots__ = ['key','value','unit','errorlevel']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.errorlevel,) = _get_struct_f().unpack(str[start:end])
      return self
