...
{
  new (message_memory) anscer_msgs::msg::BatteryInfo(_init);
}

void BatteryInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<anscer_msgs::msg::BatteryInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryInfo_message_member_array[3] = {
  {
    ...
    offsetof(anscer_msgs::msg::BatteryInfo, voltage),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(anscer_msgs::msg::BatteryInfo, percentage),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(anscer_msgs::msg::BatteryInfo, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(anscer_msgs::msg::BatteryInfo),
...
get_message_type_support_handle<anscer_msgs::msg::BatteryInfo>()
{
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, anscer_msgs, msg, BatteryInfo)() {
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryInfo_message_type_support_handle;
}
