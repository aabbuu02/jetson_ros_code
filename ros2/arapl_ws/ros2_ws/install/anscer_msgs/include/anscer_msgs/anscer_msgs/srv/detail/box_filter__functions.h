...
#ifndef ANSCER_MSGS__SRV__DETAIL__BOX_FILTER__FUNCTIONS_H_
#define ANSCER_MSGS__SRV__DETAIL__BOX_FILTER__FUNCTIONS_H_
...
/// Initialize srv/BoxFilter message.
/**
...
/// Finalize srv/BoxFilter message.
/**
...
/// Create srv/BoxFilter message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * anscer_msgs__srv__BoxFilter_Request__init().
...
/// Destroy srv/BoxFilter message.
/**
 * It calls
 * anscer_msgs__srv__BoxFilter_Request__fini()
...
/// Check for srv/BoxFilter message equality.
/**
...
/// Initialize array of srv/BoxFilter messages.
/**
...
/// Finalize array of srv/BoxFilter messages.
/**
 * It calls
 * anscer_msgs__srv__BoxFilter_Request__fini()
...
/// Create array of srv/BoxFilter messages.
/**
 * It allocates the memory for the array and calls
 * anscer_msgs__srv__BoxFilter_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/BoxFilter messages.
/**
 * It calls
 * anscer_msgs__srv__BoxFilter_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/BoxFilter message array equality.
/**
...
/// Copy an array of srv/BoxFilter messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * anscer_msgs__srv__BoxFilter_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It calls
 * anscer_msgs__srv__BoxFilter_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It allocates the memory for the array and calls
 * anscer_msgs__srv__BoxFilter_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It calls
 * anscer_msgs__srv__BoxFilter_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ANSCER_MSGS__SRV__DETAIL__BOX_FILTER__FUNCTIONS_H_
