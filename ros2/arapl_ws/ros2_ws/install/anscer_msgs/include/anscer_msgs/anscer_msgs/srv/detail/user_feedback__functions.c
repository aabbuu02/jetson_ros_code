...
anscer_msgs__srv__UserFeedback_Request__are_equal(const anscer_msgs__srv__UserFeedback_Request * lhs, const anscer_msgs__srv__UserFeedback_Request * rhs)
{
  ...
  // user_feedback
  if (lhs->user_feedback != rhs->user_feedback) {
    return false;
  }
  return true;
}
  ...
  anscer_msgs__srv__UserFeedback_Request * output)
{
  ...
  // user_feedback
  output->user_feedback = input->user_feedback;
  return true;
}
...
anscer_msgs__srv__UserFeedback_Request__create()
{
  ...
  anscer_msgs__srv__UserFeedback_Request * msg = (anscer_msgs__srv__UserFeedback_Request *)allocator.allocate(sizeof(anscer_msgs__srv__UserFeedback_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(anscer_msgs__srv__UserFeedback_Request));
  bool success = anscer_msgs__srv__UserFeedback_Request__init(msg);
  if (!success) {
...
anscer_msgs__srv__UserFeedback_Request__destroy(anscer_msgs__srv__UserFeedback_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    anscer_msgs__srv__UserFeedback_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
anscer_msgs__srv__UserFeedback_Request__Sequence__init(anscer_msgs__srv__UserFeedback_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  anscer_msgs__srv__UserFeedback_Request * data = NULL;

  if (size) {
    data = (anscer_msgs__srv__UserFeedback_Request *)allocator.zero_allocate(size, sizeof(anscer_msgs__srv__UserFeedback_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = anscer_msgs__srv__UserFeedback_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        anscer_msgs__srv__UserFeedback_Request__fini(&data[i - 1]);
      }
...
anscer_msgs__srv__UserFeedback_Request__Sequence__fini(anscer_msgs__srv__UserFeedback_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      anscer_msgs__srv__UserFeedback_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  anscer_msgs__srv__UserFeedback_Request__Sequence * array = (anscer_msgs__srv__UserFeedback_Request__Sequence *)allocator.allocate(sizeof(anscer_msgs__srv__UserFeedback_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = anscer_msgs__srv__UserFeedback_Request__Sequence__init(array, size);
  if (!success) {
...
anscer_msgs__srv__UserFeedback_Request__Sequence__destroy(anscer_msgs__srv__UserFeedback_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    anscer_msgs__srv__UserFeedback_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
anscer_msgs__srv__UserFeedback_Request__Sequence__are_equal(const anscer_msgs__srv__UserFeedback_Request__Sequence * lhs, const anscer_msgs__srv__UserFeedback_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!anscer_msgs__srv__UserFeedback_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  anscer_msgs__srv__UserFeedback_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(anscer_msgs__srv__UserFeedback_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    anscer_msgs__srv__UserFeedback_Request * data =
      (anscer_msgs__srv__UserFeedback_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!anscer_msgs__srv__UserFeedback_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          anscer_msgs__srv__UserFeedback_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!anscer_msgs__srv__UserFeedback_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  anscer_msgs__srv__UserFeedback_Response * msg = (anscer_msgs__srv__UserFeedback_Response *)allocator.allocate(sizeof(anscer_msgs__srv__UserFeedback_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(anscer_msgs__srv__UserFeedback_Response));
  bool success = anscer_msgs__srv__UserFeedback_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
anscer_msgs__srv__UserFeedback_Response__destroy(anscer_msgs__srv__UserFeedback_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    anscer_msgs__srv__UserFeedback_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
anscer_msgs__srv__UserFeedback_Response__Sequence__init(anscer_msgs__srv__UserFeedback_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  anscer_msgs__srv__UserFeedback_Response * data = NULL;

  if (size) {
    data = (anscer_msgs__srv__UserFeedback_Response *)allocator.zero_allocate(size, sizeof(anscer_msgs__srv__UserFeedback_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = anscer_msgs__srv__UserFeedback_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        anscer_msgs__srv__UserFeedback_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
anscer_msgs__srv__UserFeedback_Response__Sequence__fini(anscer_msgs__srv__UserFeedback_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      anscer_msgs__srv__UserFeedback_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  anscer_msgs__srv__UserFeedback_Response__Sequence * array = (anscer_msgs__srv__UserFeedback_Response__Sequence *)allocator.allocate(sizeof(anscer_msgs__srv__UserFeedback_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = anscer_msgs__srv__UserFeedback_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
anscer_msgs__srv__UserFeedback_Response__Sequence__destroy(anscer_msgs__srv__UserFeedback_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    anscer_msgs__srv__UserFeedback_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
anscer_msgs__srv__UserFeedback_Response__Sequence__are_equal(const anscer_msgs__srv__UserFeedback_Response__Sequence * lhs, const anscer_msgs__srv__UserFeedback_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!anscer_msgs__srv__UserFeedback_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  anscer_msgs__srv__UserFeedback_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(anscer_msgs__srv__UserFeedback_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    anscer_msgs__srv__UserFeedback_Response * data =
      (anscer_msgs__srv__UserFeedback_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!anscer_msgs__srv__UserFeedback_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          anscer_msgs__srv__UserFeedback_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!anscer_msgs__srv__UserFeedback_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
