...
{
  new (message_memory) anscer_msgs::msg::BatteryState(_init);
}

void BatteryState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<anscer_msgs::msg::BatteryState *>(message_memory);
  typed_message->~BatteryState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BatteryState_message_member_array[2] = {
  {
    "voltage",  // name
    ...
    offsetof(anscer_msgs::msg::BatteryState, voltage),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(anscer_msgs::msg::BatteryState, current),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BatteryState_message_members = {
  ...
  2,  // number of fields
  sizeof(anscer_msgs::msg::BatteryState),
...
{
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, anscer_msgs, msg, BatteryState)() {
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::BatteryState_message_type_support_handle;
}
