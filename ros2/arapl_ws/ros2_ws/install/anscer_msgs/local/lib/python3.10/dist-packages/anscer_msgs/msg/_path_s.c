...
bool anscer_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * anscer_msgs__msg__pose__convert_to_py(void * raw_ros_message);
...
bool anscer_msgs__msg__path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._path.Path", full_classname_dest, 26) == 0);
  }
  anscer_msgs__msg__Path * ros_message = _ros_message;
  {  // agent_name
  ...
  {  // pose
    ...
    if (!anscer_msgs__msg__Pose__Sequence__init(&(ros_message->pose), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create anscer_msgs__msg__Pose__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    anscer_msgs__msg__Pose * dest = ros_message->pose.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!anscer_msgs__msg__pose__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * anscer_msgs__msg__path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._path");
  ...
  anscer_msgs__msg__Path * ros_message = (anscer_msgs__msg__Path *)raw_ros_message;
  {  // agent_name
    PyObject * field = NULL;
  ...
  {  // pose
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = anscer_msgs__msg__pose__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
