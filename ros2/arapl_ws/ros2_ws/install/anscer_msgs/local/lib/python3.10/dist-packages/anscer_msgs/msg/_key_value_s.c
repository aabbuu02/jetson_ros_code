...
bool anscer_msgs__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._key_value.KeyValue", full_classname_dest, 35) == 0);
  }
  anscer_msgs__msg__KeyValue * ros_message = _ros_message;
  {  // key
  ...
  {  // errorlevel
    PyObject * field = PyObject_GetAttrString(_pymsg, "errorlevel");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->errorlevel = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * anscer_msgs__msg__key_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._key_value");
  ...
  anscer_msgs__msg__KeyValue * ros_message = (anscer_msgs__msg__KeyValue *)raw_ros_message;
  {  // key
    PyObject * field = NULL;
  ...
  {  // errorlevel
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->errorlevel);
    {
      int rc = PyObject_SetAttrString(_pymessage, "errorlevel", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
