...
bool anscer_msgs__msg__zone_points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._zone_points.ZonePoints", full_classname_dest, 39) == 0);
  }
  anscer_msgs__msg__ZonePoints * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of ZonePoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._zone_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ZonePoints");
  ...
  anscer_msgs__msg__ZonePoints * ros_message = (anscer_msgs__msg__ZonePoints *)raw_ros_message;
  {  // index
    PyObject * field = NULL;
