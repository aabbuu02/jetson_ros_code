...
bool anscer_msgs__msg__mission_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._mission_status.MissionStatus", full_classname_dest, 45) == 0);
  }
  anscer_msgs__msg__MissionStatus * ros_message = _ros_message;
  {  // mission_id
...
PyObject * anscer_msgs__msg__mission_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._mission_status");
  ...
  anscer_msgs__msg__MissionStatus * ros_message = (anscer_msgs__msg__MissionStatus *)raw_ros_message;
  {  // mission_id
    PyObject * field = NULL;
