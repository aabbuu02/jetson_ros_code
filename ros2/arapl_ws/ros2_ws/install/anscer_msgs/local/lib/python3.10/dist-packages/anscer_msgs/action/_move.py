...
class Metaclass_Move_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Move_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Move_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_Feedback(metaclass=Metaclass_Move_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.move_feedback = kwargs.get('move_feedback', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.move_feedback != other.move_feedback:
            return False
        return True
    ...
    @builtins.property
    def move_feedback(self):
        """Message field 'move_feedback'."""
        return self._move_feedback

    @move_feedback.setter
    def move_feedback(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'move_feedback' field must be of type 'bool'"
        self._move_feedback = value
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'anscer_msgs/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from anscer_msgs.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from anscer_msgs.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from anscer_msgs.action._move import Move_SendGoal_Request as Request
    from anscer_msgs.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'anscer_msgs/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from anscer_msgs.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from anscer_msgs.action._move import Move_GetResult_Request as Request
    from anscer_msgs.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'anscer_msgs/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from anscer_msgs.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from anscer_msgs.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from anscer_msgs.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from anscer_msgs.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from anscer_msgs.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from anscer_msgs.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from anscer_msgs.action._move import Move_FeedbackMessage as FeedbackMessage
