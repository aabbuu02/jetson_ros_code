...
bool anscer_msgs__msg__indication__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._indication.Indication", full_classname_dest, 38) == 0);
  }
  anscer_msgs__msg__Indication * ros_message = _ros_message;
  {  // color
  ...
  {  // color_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "color_mode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->color_mode = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // buzzer
  ...
  {  // buzzer_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "buzzer_mode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->buzzer_mode = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // priority
...
{
  /* NOTE(esteve): Call constructor of Indication */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._indication");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Indication");
  ...
  anscer_msgs__msg__Indication * ros_message = (anscer_msgs__msg__Indication *)raw_ros_message;
  {  // color
    PyObject * field = NULL;
  ...
  {  // color_mode
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->color_mode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "color_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // buzzer_mode
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->buzzer_mode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "buzzer_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
