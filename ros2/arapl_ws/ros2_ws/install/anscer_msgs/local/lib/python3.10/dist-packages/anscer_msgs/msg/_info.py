...
class Metaclass_Info(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.msg import KeyValues
...
class Info(metaclass=Metaclass_Info):
    ...
    _fields_and_field_types = {
        ...
        'keyvalues': 'anscer_msgs/KeyValues',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'msg'], 'KeyValues'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from anscer_msgs.msg import KeyValues
        self.keyvalues = kwargs.get('keyvalues', KeyValues())
    ...
    def keyvalues(self, value):
        if __debug__:
            from anscer_msgs.msg import KeyValues
            assert \
                isinstance(value, KeyValues), \
                "The 'keyvalues' field must be a sub message of type 'KeyValues'"
