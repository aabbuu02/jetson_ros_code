...
bool anscer_msgs__msg__battery_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._battery_state.BatteryState", full_classname_dest, 43) == 0);
  }
  anscer_msgs__msg__BatteryState * ros_message = _ros_message;
  {  // voltage
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * anscer_msgs__msg__battery_state__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of BatteryState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._battery_state");
  ...
  anscer_msgs__msg__BatteryState * ros_message = (anscer_msgs__msg__BatteryState *)raw_ros_message;
  {  // voltage
    PyObject * field = NULL;
