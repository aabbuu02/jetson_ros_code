...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/twist_mux"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/twist_mux/environment/library_path.sh"
