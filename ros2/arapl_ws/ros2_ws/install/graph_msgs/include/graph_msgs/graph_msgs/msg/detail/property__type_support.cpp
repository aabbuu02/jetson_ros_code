...
{
  new (message_memory) graph_msgs::msg::Property(_init);
}

void Property_fini_function(void * message_memory)
{
  auto typed_message = static_cast<graph_msgs::msg::Property *>(message_memory);
  typed_message->~Property();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Property_message_member_array[2] = {
  {
    "key",  // name
    ...
    offsetof(graph_msgs::msg::Property, key),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(graph_msgs::msg::Property, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Property_message_members = {
  ...
  2,  // number of fields
  sizeof(graph_msgs::msg::Property),
...
get_message_type_support_handle<graph_msgs::msg::Property>()
{
  return &::graph_msgs::msg::rosidl_typesupport_introspection_cpp::Property_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_msgs, msg, Property)() {
  return &::graph_msgs::msg::rosidl_typesupport_introspection_cpp::Property_message_type_support_handle;
}
