...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/anscer_teleop"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/anscer_teleop/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/anscer_teleop/environment/path.sh"
