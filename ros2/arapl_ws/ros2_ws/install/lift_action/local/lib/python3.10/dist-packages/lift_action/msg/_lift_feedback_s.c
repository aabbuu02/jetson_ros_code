...
bool lift_action__msg__lift_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lift_action.msg._lift_feedback.LiftFeedback", full_classname_dest, 43) == 0);
  }
  lift_action__msg__LiftFeedback * ros_message = _ros_message;
  {  // unique_id
  ...
  {  // fail_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "fail_status");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->fail_status = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LiftFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lift_action.msg._lift_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LiftFeedback");
  ...
  {  // fail_status
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->fail_status ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fail_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
