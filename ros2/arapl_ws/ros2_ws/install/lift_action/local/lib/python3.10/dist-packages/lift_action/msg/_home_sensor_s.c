...
bool lift_action__msg__home_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lift_action.msg._home_sensor.HomeSensor", full_classname_dest, 39) == 0);
  }
  lift_action__msg__HomeSensor * ros_message = _ros_message;
  {  // process
...
{
  /* NOTE(esteve): Call constructor of HomeSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lift_action.msg._home_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HomeSensor");
