...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/graph_server"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/graph_server/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/graph_server/environment/path.sh"
