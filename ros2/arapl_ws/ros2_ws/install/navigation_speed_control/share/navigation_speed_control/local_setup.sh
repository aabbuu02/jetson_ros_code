...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/navigation_speed_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/navigation_speed_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/navigation_speed_control/environment/path.sh"
