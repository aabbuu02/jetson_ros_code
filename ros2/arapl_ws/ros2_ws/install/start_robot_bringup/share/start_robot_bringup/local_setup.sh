...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/start_robot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_robot_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/start_robot_bringup/environment/path.sh"
