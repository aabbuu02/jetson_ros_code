...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/brake_action"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brake_action/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/brake_action/environment/path.sh"
