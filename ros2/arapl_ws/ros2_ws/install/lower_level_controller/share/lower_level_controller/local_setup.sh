...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/lower_level_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lower_level_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lower_level_controller/environment/path.sh"
