...
#ifndef GRAPH_CREATOR_MSGS__SRV__DETAIL__LOAD_GRAPH__FUNCTIONS_H_
#define GRAPH_CREATOR_MSGS__SRV__DETAIL__LOAD_GRAPH__FUNCTIONS_H_
 ...
 * calls
 * graph_creator_msgs__srv__LoadGraph_Request__init().
...
/**
 * It calls
 * graph_creator_msgs__srv__LoadGraph_Request__fini()
 ...
 * graph_creator_msgs__srv__LoadGraph_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * graph_creator_msgs__srv__LoadGraph_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * graph_creator_msgs__srv__LoadGraph_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_graph_creator_msgs
...
/**
 * It calls
 * graph_creator_msgs__srv__LoadGraph_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_graph_creator_msgs
...
/**
 * It allocates the memory for the array and calls
 * graph_creator_msgs__srv__LoadGraph_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_graph_creator_msgs
...
/**
 * It calls
 * graph_creator_msgs__srv__LoadGraph_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GRAPH_CREATOR_MSGS__SRV__DETAIL__LOAD_GRAPH__FUNCTIONS_H_
