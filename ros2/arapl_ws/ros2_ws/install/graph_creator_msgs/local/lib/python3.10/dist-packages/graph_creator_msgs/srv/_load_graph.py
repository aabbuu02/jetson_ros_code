...
class Metaclass_LoadGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from graph_creator_msgs.srv import _load_graph
...
class LoadGraph(metaclass=Metaclass_LoadGraph):
    from graph_creator_msgs.srv._load_graph import LoadGraph_Request as Request
    from graph_creator_msgs.srv._load_graph import LoadGraph_Response as Response
