...
class Metaclass_SaveGraph(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from graph_creator_msgs.srv import _save_graph
...
class SaveGraph(metaclass=Metaclass_SaveGraph):
    from graph_creator_msgs.srv._save_graph import SaveGraph_Request as Request
    from graph_creator_msgs.srv._save_graph import SaveGraph_Response as Response
