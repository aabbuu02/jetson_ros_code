...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/acr_robot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acr_robot_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/acr_robot_controller/environment/path.sh"
