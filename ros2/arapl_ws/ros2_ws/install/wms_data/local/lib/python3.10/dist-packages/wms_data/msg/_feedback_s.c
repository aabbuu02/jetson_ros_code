...
bool wms_data__msg__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wms_data.msg._feedback.Feedback", full_classname_dest, 31) == 0);
  }
  wms_data__msg__Feedback * ros_message = _ros_message;
  {  // unique_id
...
PyObject * wms_data__msg__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("wms_data.msg._feedback");
