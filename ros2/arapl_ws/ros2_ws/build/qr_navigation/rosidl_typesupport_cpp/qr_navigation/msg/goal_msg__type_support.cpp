...
static const _GoalMsg_type_support_symbol_names_t _GoalMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, qr_navigation, msg, GoalMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, qr_navigation, msg, GoalMsg)),
  }
};
...
{
  return &::qr_navigation::msg::rosidl_typesupport_cpp::GoalMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, qr_navigation, msg, GoalMsg)() {
  return get_message_type_support_handle<qr_navigation::msg::GoalMsg>();
}
