...
#include "anscer_msgs/action/detail/charge__rosidl_typesupport_fastrtps_c.h"
...
#include "anscer_msgs/msg/detail/charge_info__functions.h"  // charge_info
...
using _Charge_Goal__ros_msg_type = anscer_msgs__action__Charge_Goal;
  ...
  // Field name: charge_info
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, anscer_msgs, msg, ChargeInfo
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_Goal__ros_msg_type * ros_message = static_cast<_Charge_Goal__ros_msg_type *>(untyped_ros_message);
  // Field name: charge_info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_anscer_msgs__action__Charge_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_Goal__ros_msg_type * ros_message = static_cast<const _Charge_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_anscer_msgs__msg__ChargeInfo(
...
static uint32_t _Charge_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: charge_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_anscer_msgs__msg__ChargeInfo(
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__action__Charge_Goal;
    is_plain =
      (
...
static size_t _Charge_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Goal)() {
...
using _Charge_Result__ros_msg_type = anscer_msgs__action__Charge_Result;
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_Result__ros_msg_type * ros_message = static_cast<_Charge_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: is_success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_Result__ros_msg_type * ros_message = static_cast<const _Charge_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_Result;
    is_plain =
      (
...
static size_t _Charge_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Result)() {
...
using _Charge_Feedback__ros_msg_type = anscer_msgs__action__Charge_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: charge_feedback
  {
    cdr << ros_message->charge_feedback;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_Feedback__ros_msg_type * ros_message = static_cast<_Charge_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: charge_feedback
  {
    cdr >> ros_message->charge_feedback;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_Feedback__ros_msg_type * ros_message = static_cast<const _Charge_Feedback__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name charge_feedback
  {
    size_t item_size = sizeof(ros_message->charge_feedback);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name time_elapsed
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_Feedback;
    is_plain =
      (
...
static size_t _Charge_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Feedback)() {
...
// already included above
// #include "anscer_msgs/action/detail/charge__functions.h"  // goal
...
using _Charge_SendGoal_Request__ros_msg_type = anscer_msgs__action__Charge_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_SendGoal_Request__ros_msg_type * ros_message = static_cast<_Charge_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Charge_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_anscer_msgs__action__Charge_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_anscer_msgs__action__Charge_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_SendGoal_Request;
    is_plain =
      (
...
static size_t _Charge_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_SendGoal_Request)() {
...
using _Charge_SendGoal_Response__ros_msg_type = anscer_msgs__action__Charge_SendGoal_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_SendGoal_Response__ros_msg_type * ros_message = static_cast<_Charge_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Charge_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_SendGoal_Response;
    is_plain =
      (
...
static size_t _Charge_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_SendGoal)() {
...
using _Charge_GetResult_Request__ros_msg_type = anscer_msgs__action__Charge_GetResult_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_GetResult_Request__ros_msg_type * ros_message = static_cast<_Charge_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Charge_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_GetResult_Request;
    is_plain =
      (
...
static size_t _Charge_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_GetResult_Request)() {
...
// already included above
// #include "anscer_msgs/action/detail/charge__functions.h"  // result
...
using _Charge_GetResult_Response__ros_msg_type = anscer_msgs__action__Charge_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_GetResult_Response__ros_msg_type * ros_message = static_cast<_Charge_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Charge_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_anscer_msgs__action__Charge_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_anscer_msgs__action__Charge_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_GetResult_Response;
    is_plain =
      (
...
static size_t _Charge_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_GetResult)() {
...
// already included above
// #include "anscer_msgs/action/detail/charge__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Charge_FeedbackMessage__ros_msg_type = anscer_msgs__action__Charge_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _Charge_FeedbackMessage__ros_msg_type * ros_message = static_cast<_Charge_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__action__Charge_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Charge_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Charge_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_anscer_msgs__action__Charge_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__action__Charge_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__action__Charge_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_anscer_msgs__action__Charge_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__action__Charge_FeedbackMessage;
    is_plain =
      (
...
static size_t _Charge_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__action__Charge_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, action, Charge_FeedbackMessage)() {
