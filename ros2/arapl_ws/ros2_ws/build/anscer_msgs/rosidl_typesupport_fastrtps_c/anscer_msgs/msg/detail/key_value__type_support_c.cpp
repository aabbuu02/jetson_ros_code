...
#include "anscer_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // key, unit, value
#include "rosidl_runtime_c/string_functions.h"  // key, unit, value

// forward declare type support functions


using _KeyValue__ros_msg_type = anscer_msgs__msg__KeyValue;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: errorlevel
  {
    cdr << ros_message->errorlevel;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name errorlevel
  {
    size_t item_size = sizeof(ros_message->errorlevel);
...
static uint32_t _KeyValue__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__KeyValue(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__KeyValue;
    is_plain =
      (
      offsetof(DataType, errorlevel) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _KeyValue__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__KeyValue(
