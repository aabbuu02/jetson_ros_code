...
#include "anscer_msgs/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
#include "anscer_msgs/msg/detail/pose__functions.h"  // pose
#include "rosidl_runtime_c/string.h"  // agent_name
#include "rosidl_runtime_c/string_functions.h"  // agent_name

// forward declare type support functions
size_t get_serialized_size_anscer_msgs__msg__Pose(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_anscer_msgs__msg__Pose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, Pose)();


using _Path__ros_msg_type = anscer_msgs__msg__Path;
  ...
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, anscer_msgs, msg, Pose
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: pose
  {
    ...
    if (ros_message->pose.data) {
      anscer_msgs__msg__Pose__Sequence__fini(&ros_message->pose);
    }
    if (!anscer_msgs__msg__Pose__Sequence__init(&ros_message->pose, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_anscer_msgs__msg__Pose(
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Path(
  ...
  size_t current_alignment)
{
  ...
  // member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_anscer_msgs__msg__Pose(
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Path;
    is_plain =
      (
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Path(
