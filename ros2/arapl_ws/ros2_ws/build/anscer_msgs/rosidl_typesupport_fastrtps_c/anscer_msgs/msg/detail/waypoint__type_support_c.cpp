...
#include "anscer_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // id, map_name, name, type
#include "rosidl_runtime_c/string_functions.h"  // id, map_name, name, type
...
using _Waypoint__ros_msg_type = anscer_msgs__msg__Waypoint;
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Waypoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Waypoint;
    is_plain =
      (
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Waypoint(
