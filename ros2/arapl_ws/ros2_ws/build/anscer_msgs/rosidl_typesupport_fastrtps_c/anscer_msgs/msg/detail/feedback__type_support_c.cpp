...
#include "anscer_msgs/msg/detail/feedback__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // index, mission_id
#include "rosidl_runtime_c/string_functions.h"  // index, mission_id
...
using _Feedback__ros_msg_type = anscer_msgs__msg__Feedback;
...
static uint32_t _Feedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Feedback(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Feedback;
    is_plain =
      (
...
static size_t _Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Feedback(
