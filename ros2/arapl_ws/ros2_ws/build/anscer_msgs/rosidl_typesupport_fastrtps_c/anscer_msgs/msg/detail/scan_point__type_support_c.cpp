...
#include "anscer_msgs/msg/detail/scan_point__rosidl_typesupport_fastrtps_c.h"
...
using _ScanPoint__ros_msg_type = anscer_msgs__msg__ScanPoint;
...
static uint32_t _ScanPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__ScanPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__ScanPoint;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _ScanPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__ScanPoint(
