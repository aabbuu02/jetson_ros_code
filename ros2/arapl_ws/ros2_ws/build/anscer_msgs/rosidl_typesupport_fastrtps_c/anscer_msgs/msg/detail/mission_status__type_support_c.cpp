...
#include "anscer_msgs/msg/detail/mission_status__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // mission_id, task_id
#include "rosidl_runtime_c/string_functions.h"  // mission_id, task_id

// forward declare type support functions


using _MissionStatus__ros_msg_type = anscer_msgs__msg__MissionStatus;
...
static uint32_t _MissionStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__MissionStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__MissionStatus;
    is_plain =
      (
...
static size_t _MissionStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__MissionStatus(
