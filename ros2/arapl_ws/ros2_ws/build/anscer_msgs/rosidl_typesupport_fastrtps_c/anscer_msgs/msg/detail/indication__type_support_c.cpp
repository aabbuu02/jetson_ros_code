...
#include "anscer_msgs/msg/detail/indication__rosidl_typesupport_fastrtps_c.h"
...
using _Indication__ros_msg_type = anscer_msgs__msg__Indication;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Indication__ros_msg_type * ros_message = static_cast<const _Indication__ros_msg_type *>(untyped_ros_message);
  // Field name: color
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Indication__ros_msg_type * ros_message = static_cast<_Indication__ros_msg_type *>(untyped_ros_message);
  // Field name: color
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Indication__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Indication(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Indication;
    is_plain =
      (
...
static size_t _Indication__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Indication(
...
static message_type_support_callbacks_t __callbacks_Indication = {
  "anscer_msgs::msg",
  "Indication",
