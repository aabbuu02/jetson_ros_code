...
#include "anscer_msgs/msg/detail/delay__rosidl_typesupport_fastrtps_c.h"
...
using _Delay__ros_msg_type = anscer_msgs__msg__Delay;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Delay__ros_msg_type * ros_message = static_cast<const _Delay__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Delay__ros_msg_type * ros_message = static_cast<_Delay__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Delay__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Delay(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Delay;
    is_plain =
      (
...
static size_t _Delay__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Delay(
...
static message_type_support_callbacks_t __callbacks_Delay = {
  "anscer_msgs::msg",
  "Delay",
...
static rosidl_message_type_support_t _Delay__type_support = {
