...
#include "anscer_msgs/msg/detail/sequence__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // seq_element
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // seq_element
...
using _Sequence__ros_msg_type = anscer_msgs__msg__Sequence;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: seq_element
  {
    size_t size = ros_message->seq_element.size;
    auto array_ptr = ros_message->seq_element.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: seq_element
  {
    ...
    if (ros_message->seq_element.data) {
      rosidl_runtime_c__int16__Sequence__fini(&ros_message->seq_element);
    }
    if (!rosidl_runtime_c__int16__Sequence__init(&ros_message->seq_element, size)) {
      fprintf(stderr, "failed to create array for field 'seq_element'");
      return false;
    }
    auto array_ptr = ros_message->seq_element.data;
...
size_t get_serialized_size_anscer_msgs__msg__Sequence(
  const void * untyped_ros_message,
...
static uint32_t _Sequence__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__Sequence(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__msg__Sequence(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__Sequence;
    is_plain =
      (
...
static size_t _Sequence__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__Sequence(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, Sequence)() {
