...
#include "anscer_msgs/msg/detail/safety_zone__rosidl_typesupport_fastrtps_c.h"
...
using _SafetyZone__ros_msg_type = anscer_msgs__msg__SafetyZone;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: front_zone
  {
    cdr << ros_message->front_zone;
  }

  // Field name: rear_zone
  {
    cdr << ros_message->rear_zone;
  }
...
size_t get_serialized_size_anscer_msgs__msg__SafetyZone(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name front_zone
  {
    size_t item_size = sizeof(ros_message->front_zone);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rear_zone
  {
    size_t item_size = sizeof(ros_message->rear_zone);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _SafetyZone__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__SafetyZone(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__msg__SafetyZone(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__SafetyZone;
    is_plain =
      (
      offsetof(DataType, rear_zone) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SafetyZone__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__SafetyZone(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, SafetyZone)() {
