...
#include "anscer_msgs/msg/detail/zone_info__rosidl_typesupport_fastrtps_c.h"
...
using _ZoneInfo__ros_msg_type = anscer_msgs__msg__ZoneInfo;
...
static uint32_t _ZoneInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__ZoneInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__ZoneInfo;
    is_plain =
      (
...
static size_t _ZoneInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__ZoneInfo(
