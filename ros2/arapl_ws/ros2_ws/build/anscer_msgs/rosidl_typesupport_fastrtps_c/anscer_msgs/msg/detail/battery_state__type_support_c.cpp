...
#include "anscer_msgs/msg/detail/battery_state__rosidl_typesupport_fastrtps_c.h"
...
using _BatteryState__ros_msg_type = anscer_msgs__msg__BatteryState;
...
size_t get_serialized_size_anscer_msgs__msg__BatteryState(
  const void * untyped_ros_message,
...
static uint32_t _BatteryState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__msg__BatteryState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__msg__BatteryState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__msg__BatteryState;
    is_plain =
      (
...
static size_t _BatteryState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__msg__BatteryState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, BatteryState)() {
