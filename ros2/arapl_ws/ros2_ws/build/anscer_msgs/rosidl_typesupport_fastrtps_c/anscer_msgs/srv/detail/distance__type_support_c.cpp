...
#include "anscer_msgs/srv/detail/distance__rosidl_typesupport_fastrtps_c.h"
...
using _Distance_Request__ros_msg_type = anscer_msgs__srv__Distance_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: mission_reset
  {
    cdr << (ros_message->mission_reset ? true : false);
  }

  // Field name: total_reset
  {
...
size_t get_serialized_size_anscer_msgs__srv__Distance_Request(
  const void * untyped_ros_message,
...
static uint32_t _Distance_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__srv__Distance_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__srv__Distance_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs__srv__Distance_Request;
    is_plain =
      (
...
static size_t _Distance_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__srv__Distance_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, srv, Distance_Request)() {
...
using _Distance_Response__ros_msg_type = anscer_msgs__srv__Distance_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t get_serialized_size_anscer_msgs__srv__Distance_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Distance_Response__ros_msg_type * ros_message = static_cast<const _Distance_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_anscer_msgs__srv__Distance_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_anscer_msgs
size_t max_serialized_size_anscer_msgs__srv__Distance_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs__srv__Distance_Response;
    is_plain =
      (
...
static size_t _Distance_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_anscer_msgs__srv__Distance_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, srv, Distance_Response)() {
...
// already included above
// #include "anscer_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "anscer_msgs/srv/distance.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, srv, Distance)() {
