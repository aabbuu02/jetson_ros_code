...
#include "anscer_msgs/msg/detail/paths__type_support.h"
...
static const _Paths_type_support_symbol_names_t _Paths_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, Paths)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, Paths)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, Paths)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::Paths_message_type_support_handle;
}
