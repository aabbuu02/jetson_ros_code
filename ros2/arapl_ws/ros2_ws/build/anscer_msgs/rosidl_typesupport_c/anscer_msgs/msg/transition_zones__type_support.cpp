...
#include "anscer_msgs/msg/detail/transition_zones__type_support.h"
...
static const _TransitionZones_type_support_symbol_names_t _TransitionZones_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, TransitionZones)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, TransitionZones)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, TransitionZones)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::TransitionZones_message_type_support_handle;
}
