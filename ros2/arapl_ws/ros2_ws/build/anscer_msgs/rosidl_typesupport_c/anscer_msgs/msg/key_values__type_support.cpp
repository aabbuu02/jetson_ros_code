...
#include "anscer_msgs/msg/detail/key_values__type_support.h"
...
static const _KeyValues_type_support_symbol_names_t _KeyValues_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, KeyValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, KeyValues)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, KeyValues)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::KeyValues_message_type_support_handle;
}
