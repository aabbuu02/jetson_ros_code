...
#include "anscer_msgs/msg/detail/field_status__type_support.h"
...
static const _FieldStatus_type_support_symbol_names_t _FieldStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, FieldStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, FieldStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, FieldStatus)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::FieldStatus_message_type_support_handle;
}
