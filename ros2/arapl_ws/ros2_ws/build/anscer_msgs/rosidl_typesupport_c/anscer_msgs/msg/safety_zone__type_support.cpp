...
#include "anscer_msgs/msg/detail/safety_zone__type_support.h"
...
static const _SafetyZone_type_support_symbol_names_t _SafetyZone_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, SafetyZone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, SafetyZone)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, SafetyZone)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::SafetyZone_message_type_support_handle;
}
