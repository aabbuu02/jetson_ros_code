...
#include "anscer_msgs/msg/detail/zone_info__type_support.h"
...
static const _ZoneInfo_type_support_symbol_names_t _ZoneInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, anscer_msgs, msg, ZoneInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, anscer_msgs, msg, ZoneInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, anscer_msgs, msg, ZoneInfo)() {
  return &::anscer_msgs::msg::rosidl_typesupport_c::ZoneInfo_message_type_support_handle;
}
