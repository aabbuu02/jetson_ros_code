...
class Dock_Goal(metaclass=Metaclass_Dock_Goal):
    ...
    _fields_and_field_types = {
        'aruco_charging': 'boolean',
        'reflector_charging': 'boolean',
        'general_docking': 'boolean',
        'vlmarker_charging': 'boolean',
        'start_dock': 'boolean',
        'start_undock': 'boolean',
        'inplace_id': 'int8',
        'undock_distance': 'float',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.aruco_charging = kwargs.get('aruco_charging', bool())
        self.reflector_charging = kwargs.get('reflector_charging', bool())
        self.general_docking = kwargs.get('general_docking', bool())
        self.vlmarker_charging = kwargs.get('vlmarker_charging', bool())
        self.start_dock = kwargs.get('start_dock', bool())
        self.start_undock = kwargs.get('start_undock', bool())
        self.inplace_id = kwargs.get('inplace_id', int())
        self.undock_distance = kwargs.get('undock_distance', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.aruco_charging != other.aruco_charging:
            return False
        if self.reflector_charging != other.reflector_charging:
            return False
        if self.general_docking != other.general_docking:
            return False
        if self.vlmarker_charging != other.vlmarker_charging:
            return False
        if self.start_dock != other.start_dock:
            return False
        if self.start_undock != other.start_undock:
            return False
        if self.inplace_id != other.inplace_id:
            return False
        if self.undock_distance != other.undock_distance:
            return False
        return True
    ...
    @builtins.property
    def aruco_charging(self):
        """Message field 'aruco_charging'."""
        return self._aruco_charging

    @aruco_charging.setter
    def aruco_charging(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'aruco_charging' field must be of type 'bool'"
        self._aruco_charging = value

    @builtins.property
    def reflector_charging(self):
        """Message field 'reflector_charging'."""
        return self._reflector_charging

    @reflector_charging.setter
    def reflector_charging(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'reflector_charging' field must be of type 'bool'"
        self._reflector_charging = value

    @builtins.property
    def general_docking(self):
        """Message field 'general_docking'."""
        return self._general_docking

    @general_docking.setter
    def general_docking(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'general_docking' field must be of type 'bool'"
        self._general_docking = value

    @builtins.property
    def vlmarker_charging(self):
        """Message field 'vlmarker_charging'."""
        return self._vlmarker_charging

    @vlmarker_charging.setter
    def vlmarker_charging(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'vlmarker_charging' field must be of type 'bool'"
        self._vlmarker_charging = value

    @builtins.property
    def start_dock(self):
        """Message field 'start_dock'."""
        return self._start_dock

    @start_dock.setter
    def start_dock(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'start_dock' field must be of type 'bool'"
        self._start_dock = value

    @builtins.property
    def start_undock(self):
        """Message field 'start_undock'."""
        return self._start_undock

    @start_undock.setter
    def start_undock(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'start_undock' field must be of type 'bool'"
        self._start_undock = value

    @builtins.property
    def inplace_id(self):
        """Message field 'inplace_id'."""
        return self._inplace_id

    @inplace_id.setter
    def inplace_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'inplace_id' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'inplace_id' field must be an integer in [-128, 127]"
        self._inplace_id = value

    @builtins.property
    def undock_distance(self):
        """Message field 'undock_distance'."""
        return self._undock_distance

    @undock_distance.setter
    def undock_distance(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'undock_distance' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'undock_distance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._undock_distance = value
...
class Metaclass_Dock_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Dock_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Dock_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Dock_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from anscer_msgs.msg import DockInfo
            if DockInfo.__class__._TYPE_SUPPORT is None:
                DockInfo.__class__.__import_type_support__()
...
class Dock_Feedback(metaclass=Metaclass_Dock_Feedback):
    ...
    __slots__ = [
        '_dock_info',
        '_undock_distance_remaining',
        '_dock_found',
        '_controller_status',
    ]

    _fields_and_field_types = {
        'dock_info': 'anscer_msgs/DockInfo',
        'undock_distance_remaining': 'float',
        'dock_found': 'boolean',
        'controller_status': 'int8',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'msg'], 'DockInfo'),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from anscer_msgs.msg import DockInfo
        self.dock_info = kwargs.get('dock_info', DockInfo())
        self.undock_distance_remaining = kwargs.get('undock_distance_remaining', float())
        self.dock_found = kwargs.get('dock_found', bool())
        self.controller_status = kwargs.get('controller_status', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.dock_info != other.dock_info:
            return False
        if self.undock_distance_remaining != other.undock_distance_remaining:
            return False
        if self.dock_found != other.dock_found:
            return False
    ...
    @builtins.property
    def dock_info(self):
        """Message field 'dock_info'."""
        return self._dock_info

    @dock_info.setter
    def dock_info(self, value):
        if __debug__:
            from anscer_msgs.msg import DockInfo
            assert \
                isinstance(value, DockInfo), \
                "The 'dock_info' field must be a sub message of type 'DockInfo'"
        self._dock_info = value

    @builtins.property
    def undock_distance_remaining(self):
        """Message field 'undock_distance_remaining'."""
        return self._undock_distance_remaining

    @undock_distance_remaining.setter
    def undock_distance_remaining(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'undock_distance_remaining' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'undock_distance_remaining' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._undock_distance_remaining = value

    @builtins.property
    def dock_found(self):
        """Message field 'dock_found'."""
        return self._dock_found

    @dock_found.setter
    def dock_found(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'dock_found' field must be of type 'bool'"
        self._dock_found = value
    ...
    def controller_status(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'controller_status' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'controller_status' field must be an integer in [-128, 127]"
...
class Metaclass_Dock_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.action import Dock
...
class Dock_SendGoal_Request(metaclass=Metaclass_Dock_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'anscer_msgs/Dock_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Dock_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from anscer_msgs.action._dock import Dock_Goal
...
class Metaclass_Dock_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Dock_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from anscer_msgs.action import _dock
...
class Dock_SendGoal(metaclass=Metaclass_Dock_SendGoal):
    from anscer_msgs.action._dock import Dock_SendGoal_Request as Request
    from anscer_msgs.action._dock import Dock_SendGoal_Response as Response
...
class Dock_GetResult_Response(metaclass=Metaclass_Dock_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'anscer_msgs/Dock_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Dock_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from anscer_msgs.action._dock import Dock_Result
...
class Metaclass_Dock_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Dock_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_GetResult(metaclass=Metaclass_Dock_GetResult):
    from anscer_msgs.action._dock import Dock_GetResult_Request as Request
    from anscer_msgs.action._dock import Dock_GetResult_Response as Response
...
class Metaclass_Dock_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'anscer_msgs.action.Dock_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Dock_FeedbackMessage(metaclass=Metaclass_Dock_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'anscer_msgs/Dock_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['anscer_msgs', 'action'], 'Dock_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from anscer_msgs.action._dock import Dock_Feedback
...
class Dock(metaclass=Metaclass_Dock):
    ...
    from anscer_msgs.action._dock import Dock_Goal as Goal
    # The result message defined in the action definition.
    from anscer_msgs.action._dock import Dock_Result as Result
    # The feedback message defined in the action definition.
    from anscer_msgs.action._dock import Dock_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from anscer_msgs.action._dock import Dock_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from anscer_msgs.action._dock import Dock_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from anscer_msgs.action._dock import Dock_FeedbackMessage as FeedbackMessage
