...
class Metaclass_SaveMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.srv import _save_map
...
class SaveMap(metaclass=Metaclass_SaveMap):
    from anscer_msgs.srv._save_map import SaveMap_Request as Request
    from anscer_msgs.srv._save_map import SaveMap_Response as Response
