...
bool anscer_msgs__srv__trip_analytics__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.srv._trip_analytics.TripAnalytics_Request", full_classname_dest, 53) == 0);
  }
  anscer_msgs__srv__TripAnalytics_Request * ros_message = _ros_message;
  {  // start_date
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * anscer_msgs__srv__trip_analytics__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TripAnalytics_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.srv._trip_analytics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TripAnalytics_Request");
  ...
  anscer_msgs__srv__TripAnalytics_Request * ros_message = (anscer_msgs__srv__TripAnalytics_Request *)raw_ros_message;
  {  // start_date
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool anscer_msgs__srv__trip_analytics__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.srv._trip_analytics.TripAnalytics_Response", full_classname_dest, 54) == 0);
  }
  anscer_msgs__srv__TripAnalytics_Response * ros_message = _ros_message;
  {  // mission_db
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * anscer_msgs__srv__trip_analytics__response__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of TripAnalytics_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.srv._trip_analytics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TripAnalytics_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  anscer_msgs__srv__TripAnalytics_Response * ros_message = (anscer_msgs__srv__TripAnalytics_Response *)raw_ros_message;
  {  // mission_db
    PyObject * field = NULL;
