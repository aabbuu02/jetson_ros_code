...
class Dock_Request(metaclass=Metaclass_Dock_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.dock_call = kwargs.get('dock_call', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.dock_call != other.dock_call:
            return False
        return True
    ...
    @builtins.property
    def dock_call(self):
        """Message field 'dock_call'."""
        return self._dock_call

    @dock_call.setter
    def dock_call(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'dock_call' field must be of type 'bool'"
        self._dock_call = value
...
class Metaclass_Dock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.srv import _dock
...
class Dock(metaclass=Metaclass_Dock):
    from anscer_msgs.srv._dock import Dock_Request as Request
    from anscer_msgs.srv._dock import Dock_Response as Response
