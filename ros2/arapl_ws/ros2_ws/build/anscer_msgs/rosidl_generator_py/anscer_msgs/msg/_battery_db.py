...
class Metaclass_BatteryDB(type):
    """Metaclass of message 'BatteryDB'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__battery_db
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__battery_db
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__battery_db
            cls._TYPE_SUPPORT = module.type_support_msg__msg__battery_db
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__battery_db
...
class BatteryDB(metaclass=Metaclass_BatteryDB):
    """Message class 'BatteryDB'."""
    ...
    def state_of_charge(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'state_of_charge' field must be an integer in [-128, 127]"
