...
bool anscer_msgs__msg__zone_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._zone_info.ZoneInfo", full_classname_dest, 35) == 0);
  }
  anscer_msgs__msg__ZoneInfo * ros_message = _ros_message;
  {  // index
...
{
  /* NOTE(esteve): Call constructor of ZoneInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._zone_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ZoneInfo");
  ...
  anscer_msgs__msg__ZoneInfo * ros_message = (anscer_msgs__msg__ZoneInfo *)raw_ros_message;
  {  // index
    PyObject * field = NULL;
