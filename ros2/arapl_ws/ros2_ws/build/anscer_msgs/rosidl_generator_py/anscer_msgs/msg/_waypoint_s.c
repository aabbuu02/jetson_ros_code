...
bool anscer_msgs__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._waypoint.Waypoint", full_classname_dest, 34) == 0);
  }
  anscer_msgs__msg__Waypoint * ros_message = _ros_message;
  {  // name
...
PyObject * anscer_msgs__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._waypoint");
  ...
  anscer_msgs__msg__Waypoint * ros_message = (anscer_msgs__msg__Waypoint *)raw_ros_message;
  {  // name
    PyObject * field = NULL;
