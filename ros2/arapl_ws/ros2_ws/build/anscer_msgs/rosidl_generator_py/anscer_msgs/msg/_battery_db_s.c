...
bool anscer_msgs__msg__battery_db__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._battery_db.BatteryDB", full_classname_dest, 37) == 0);
  }
  anscer_msgs__msg__BatteryDB * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // state_of_charge
    ...
    ros_message->state_of_charge = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of BatteryDB */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._battery_db");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BatteryDB");
  ...
  anscer_msgs__msg__BatteryDB * ros_message = (anscer_msgs__msg__BatteryDB *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
