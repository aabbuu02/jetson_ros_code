...
class Metaclass_Path(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.msg import Pose
...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        'agent_name': 'string',
        'pose': 'sequence<anscer_msgs/Pose>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['anscer_msgs', 'msg'], 'Pose')),  # noqa: E501
    )
