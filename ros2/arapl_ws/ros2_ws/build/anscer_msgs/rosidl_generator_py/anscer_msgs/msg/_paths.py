...
class Metaclass_Paths(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from anscer_msgs.msg import Path
...
class Paths(metaclass=Metaclass_Paths):
    ...
    _fields_and_field_types = {
        'global_path': 'sequence<anscer_msgs/Path>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['anscer_msgs', 'msg'], 'Path')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'global_path' field must be a set or sequence and each value of type 'Path'"
