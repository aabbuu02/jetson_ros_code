...
bool anscer_msgs__msg__transition_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("anscer_msgs.msg._transition_info.TransitionInfo", full_classname_dest, 47) == 0);
  }
  anscer_msgs__msg__TransitionInfo * ros_message = _ros_message;
  {  // source
  ...
  {  // pose
    ...
    if (!geometry_msgs__msg__pose_array__convert_from_py(field, &ros_message->pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TransitionInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("anscer_msgs.msg._transition_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TransitionInfo");
  ...
  anscer_msgs__msg__TransitionInfo * ros_message = (anscer_msgs__msg__TransitionInfo *)raw_ros_message;
  {  // source
    PyObject * field = NULL;
  ...
  {  // pose
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose_array__convert_to_py(&ros_message->pose);
    if (!field) {
      return NULL;
    }
    {
