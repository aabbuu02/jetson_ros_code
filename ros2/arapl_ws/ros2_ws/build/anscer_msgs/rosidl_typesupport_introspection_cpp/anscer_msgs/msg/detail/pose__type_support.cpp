...
{
  new (message_memory) anscer_msgs::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<anscer_msgs::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[2] = {
  {
    ...
    offsetof(anscer_msgs::msg::Pose, time),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(anscer_msgs::msg::Pose, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, anscer_msgs, msg, Pose)() {
  return &::anscer_msgs::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
