...
#include "anscer_msgs/msg/detail/paths__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const anscer_msgs::msg::Path &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  anscer_msgs::msg::Path &);
...
cdr_serialize(
  const anscer_msgs::msg::Paths & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::Paths & ros_message)
{
  // Member: global_path
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: global_path
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        anscer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Path(
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::Paths;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::Paths *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::Paths *>(
    untyped_ros_message);
...
static size_t _Paths__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Paths(full_bounded, is_plain, 0);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Paths__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, Paths)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Paths__handle;
}
