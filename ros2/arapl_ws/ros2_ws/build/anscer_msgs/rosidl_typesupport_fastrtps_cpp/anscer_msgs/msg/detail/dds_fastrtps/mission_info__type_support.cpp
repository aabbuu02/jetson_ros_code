...
#include "anscer_msgs/msg/detail/mission_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const anscer_msgs::msg::MissionData &,
...
cdr_serialize(
  const anscer_msgs::msg::MissionInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::MissionInfo & ros_message)
{
  // Member: mission_info
  {
    uint32_t cdrSize;
    ...
    ros_message.mission_info.resize(size);
    for (size_t i = 0; i < size; i++) {
      anscer_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.mission_info[i]);
    }
  }
  ...
  // Member: mission_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.mission_info[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: mission_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        anscer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MissionData(
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::MissionInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::MissionInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::MissionInfo *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_MissionInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, MissionInfo)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_MissionInfo__handle;
}
