...
#include "anscer_msgs/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const anscer_msgs::msg::Pose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  anscer_msgs::msg::Pose &);
...
cdr_serialize(
  const anscer_msgs::msg::Path & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::Path & ros_message)
{
  // Member: agent_name
  cdr >> ros_message.agent_name;
  ...
  size_t current_alignment)
{
  ...
  // Member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        anscer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::Path;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::Path *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, Path)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Path__handle;
}
