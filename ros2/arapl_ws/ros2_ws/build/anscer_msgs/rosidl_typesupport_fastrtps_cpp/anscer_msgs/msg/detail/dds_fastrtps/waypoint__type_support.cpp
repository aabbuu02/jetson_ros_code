...
#include "anscer_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const anscer_msgs::msg::Waypoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::Waypoint & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::Waypoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::Waypoint *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, Waypoint)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Waypoint__handle;
}
