...
#include "anscer_msgs/msg/detail/info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const anscer_msgs::msg::KeyValues &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  anscer_msgs::msg::KeyValues &);
size_t get_serialized_size(
  const anscer_msgs::msg::KeyValues &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const anscer_msgs::msg::Info & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::Info & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: keyvalues
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        anscer_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_KeyValues(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::Info;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::Info *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::Info *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Info__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, Info)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_Info__handle;
}
