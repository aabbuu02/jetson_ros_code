...
#include "anscer_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const anscer_msgs::msg::KeyValue & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::KeyValue & ros_message)
{
  // Member: key
  cdr >> ros_message.key;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::KeyValue;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::KeyValue *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_KeyValue__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, KeyValue)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_KeyValue__handle;
}
