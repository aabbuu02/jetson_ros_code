...
#include "anscer_msgs/msg/detail/scan_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const anscer_msgs::msg::ScanPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::msg::ScanPoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::ScanPoint;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::ScanPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::ScanPoint *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_ScanPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, msg, ScanPoint)() {
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_ScanPoint__handle;
}
