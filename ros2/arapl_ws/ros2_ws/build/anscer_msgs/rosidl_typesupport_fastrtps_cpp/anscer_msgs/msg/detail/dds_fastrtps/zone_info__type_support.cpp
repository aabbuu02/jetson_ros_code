...
#include "anscer_msgs/msg/detail/zone_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::msg::ZoneInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::msg::ZoneInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::msg::ZoneInfo *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::msg::typesupport_fastrtps_cpp::_ZoneInfo__handle;
}
