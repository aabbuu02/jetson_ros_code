...
#include "anscer_msgs/srv/detail/save_map__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const anscer_msgs::srv::SaveMap_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::srv::SaveMap_Request & ros_message)
{
  // Member: save_map
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = anscer_msgs::srv::SaveMap_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<anscer_msgs::srv::SaveMap_Request *>(
    untyped_ros_message);
...
{
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, srv, SaveMap_Request)() {
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_anscer_msgs
cdr_serialize(
  const anscer_msgs::srv::SaveMap_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  anscer_msgs::srv::SaveMap_Response & ros_message)
{
  // Member: status
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = anscer_msgs::srv::SaveMap_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const anscer_msgs::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<anscer_msgs::srv::SaveMap_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, srv, SaveMap_Response)() {
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap_Response__handle;
}
...
{
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, anscer_msgs, srv, SaveMap)() {
  return &anscer_msgs::srv::typesupport_fastrtps_cpp::_SaveMap__handle;
}
