...
#ifndef ANSCER_MSGS__SRV__DETAIL__NEAREST_NODE__FUNCTIONS_H_
#define ANSCER_MSGS__SRV__DETAIL__NEAREST_NODE__FUNCTIONS_H_
...
/// Initialize srv/NearestNode message.
/**
...
/// Finalize srv/NearestNode message.
/**
...
/// Create srv/NearestNode message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * anscer_msgs__srv__NearestNode_Request__init().
...
/// Destroy srv/NearestNode message.
/**
 * It calls
 * anscer_msgs__srv__NearestNode_Request__fini()
...
/// Check for srv/NearestNode message equality.
/**
...
/// Copy a srv/NearestNode message.
/**
...
/// Initialize array of srv/NearestNode messages.
/**
...
/// Finalize array of srv/NearestNode messages.
/**
 * It calls
 * anscer_msgs__srv__NearestNode_Request__fini()
...
/// Create array of srv/NearestNode messages.
/**
 * It allocates the memory for the array and calls
 * anscer_msgs__srv__NearestNode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/NearestNode messages.
/**
 * It calls
 * anscer_msgs__srv__NearestNode_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NearestNode message array equality.
/**
...
/// Copy an array of srv/NearestNode messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * anscer_msgs__srv__NearestNode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It calls
 * anscer_msgs__srv__NearestNode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It allocates the memory for the array and calls
 * anscer_msgs__srv__NearestNode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_anscer_msgs
...
/**
 * It calls
 * anscer_msgs__srv__NearestNode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ANSCER_MSGS__SRV__DETAIL__NEAREST_NODE__FUNCTIONS_H_
