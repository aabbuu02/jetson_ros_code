...
static const _LiftFeedback_type_support_symbol_names_t _LiftFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lift_action, msg, LiftFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lift_action, msg, LiftFeedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lift_action, msg, LiftFeedback)() {
  return &::lift_action::msg::rosidl_typesupport_c::LiftFeedback_message_type_support_handle;
}
