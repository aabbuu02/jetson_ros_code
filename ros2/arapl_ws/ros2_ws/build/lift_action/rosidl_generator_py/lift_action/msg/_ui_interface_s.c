...
bool lift_action__msg__ui_interface__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lift_action.msg._ui_interface.UiInterface", full_classname_dest, 41) == 0);
  }
  lift_action__msg__UiInterface * ros_message = _ros_message;
  {  // process
...
{
  /* NOTE(esteve): Call constructor of UiInterface */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lift_action.msg._ui_interface");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UiInterface");
