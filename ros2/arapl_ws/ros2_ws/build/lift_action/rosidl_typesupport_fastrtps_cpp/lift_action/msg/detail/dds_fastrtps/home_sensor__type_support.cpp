...
#include "lift_action/msg/detail/home_sensor__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lift_action::msg::HomeSensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lift_action::msg::HomeSensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lift_action::msg::HomeSensor *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HomeSensor__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const lift_action::msg::HomeSensor *>(
...
static size_t _HomeSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HomeSensor(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HomeSensor__callbacks = {
  "lift_action::msg",
  "HomeSensor",
...
static rosidl_message_type_support_t _HomeSensor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HomeSensor__callbacks,
...
{
  return &lift_action::msg::typesupport_fastrtps_cpp::_HomeSensor__handle;
}
