...
#include "lift_action/msg/detail/ui_interface__rosidl_typesupport_fastrtps_c.h"
...
using _UiInterface__ros_msg_type = lift_action__msg__UiInterface;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UiInterface__ros_msg_type * ros_message = static_cast<const _UiInterface__ros_msg_type *>(untyped_ros_message);
  // Field name: process
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UiInterface__ros_msg_type * ros_message = static_cast<_UiInterface__ros_msg_type *>(untyped_ros_message);
  // Field name: process
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_lift_action__msg__UiInterface(
  const void * untyped_ros_message,
...
static uint32_t _UiInterface__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lift_action__msg__UiInterface(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lift_action
size_t max_serialized_size_lift_action__msg__UiInterface(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lift_action__msg__UiInterface;
    is_plain =
      (
...
static size_t _UiInterface__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lift_action__msg__UiInterface(
...
static message_type_support_callbacks_t __callbacks_UiInterface = {
  "lift_action::msg",
  "UiInterface",
...
static rosidl_message_type_support_t _UiInterface__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UiInterface,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lift_action, msg, UiInterface)() {
  return &_UiInterface__type_support;
}
