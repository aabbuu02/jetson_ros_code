...
static const _GetGoal_Request_type_support_symbol_names_t _GetGoal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qr_mission_scheduler, srv, GetGoal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qr_mission_scheduler, srv, GetGoal_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qr_mission_scheduler, srv, GetGoal_Request)() {
  return &::qr_mission_scheduler::srv::rosidl_typesupport_c::GetGoal_Request_message_type_support_handle;
}
...
static const _GetGoal_Response_type_support_symbol_names_t _GetGoal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qr_mission_scheduler, srv, GetGoal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qr_mission_scheduler, srv, GetGoal_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qr_mission_scheduler, srv, GetGoal_Response)() {
  return &::qr_mission_scheduler::srv::rosidl_typesupport_c::GetGoal_Response_message_type_support_handle;
}
...
static const _GetGoal_type_support_symbol_names_t _GetGoal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qr_mission_scheduler, srv, GetGoal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qr_mission_scheduler, srv, GetGoal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, qr_mission_scheduler, srv, GetGoal)() {
  return &::qr_mission_scheduler::srv::rosidl_typesupport_c::GetGoal_service_type_support_handle;
}
