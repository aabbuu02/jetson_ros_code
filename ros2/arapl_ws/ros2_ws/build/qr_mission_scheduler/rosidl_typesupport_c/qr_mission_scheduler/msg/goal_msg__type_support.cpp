...
static const _GoalMsg_type_support_symbol_names_t _GoalMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, qr_mission_scheduler, msg, GoalMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, qr_mission_scheduler, msg, GoalMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, qr_mission_scheduler, msg, GoalMsg)() {
  return &::qr_mission_scheduler::msg::rosidl_typesupport_c::GoalMsg_message_type_support_handle;
}
