...
static const _EdgeDirectionCreationType_type_support_symbol_names_t _EdgeDirectionCreationType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_creator_msgs, msg, EdgeDirectionCreationType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_creator_msgs, msg, EdgeDirectionCreationType)),
  }
};
...
{
  return &::graph_creator_msgs::msg::rosidl_typesupport_cpp::EdgeDirectionCreationType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, graph_creator_msgs, msg, EdgeDirectionCreationType)() {
  return get_message_type_support_handle<graph_creator_msgs::msg::EdgeDirectionCreationType>();
}
