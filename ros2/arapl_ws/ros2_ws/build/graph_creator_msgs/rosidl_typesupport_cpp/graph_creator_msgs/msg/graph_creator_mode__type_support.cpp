...
static const _GraphCreatorMode_type_support_symbol_names_t _GraphCreatorMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_creator_msgs, msg, GraphCreatorMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_creator_msgs, msg, GraphCreatorMode)),
  }
};
...
{
  return &::graph_creator_msgs::msg::rosidl_typesupport_cpp::GraphCreatorMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, graph_creator_msgs, msg, GraphCreatorMode)() {
  return get_message_type_support_handle<graph_creator_msgs::msg::GraphCreatorMode>();
}
