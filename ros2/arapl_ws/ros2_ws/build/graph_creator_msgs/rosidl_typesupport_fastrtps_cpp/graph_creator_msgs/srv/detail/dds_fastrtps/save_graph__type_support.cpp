...
#include "graph_creator_msgs/srv/detail/save_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const graph_creator_msgs::srv::SaveGraph_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graph_creator_msgs::srv::SaveGraph_Request & ros_message)
{
  // Member: file_path
  cdr >> ros_message.file_path;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_creator_msgs::srv::SaveGraph_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graph_creator_msgs::srv::SaveGraph_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graph_creator_msgs::srv::SaveGraph_Request *>(
    untyped_ros_message);
...
{
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_creator_msgs, srv, SaveGraph_Request)() {
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_graph_creator_msgs
cdr_serialize(
  const graph_creator_msgs::srv::SaveGraph_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graph_creator_msgs::srv::SaveGraph_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = graph_creator_msgs::srv::SaveGraph_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graph_creator_msgs::srv::SaveGraph_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<graph_creator_msgs::srv::SaveGraph_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_creator_msgs, srv, SaveGraph_Response)() {
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph_Response__handle;
}
...
{
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_creator_msgs, srv, SaveGraph)() {
  return &graph_creator_msgs::srv::typesupport_fastrtps_cpp::_SaveGraph__handle;
}
