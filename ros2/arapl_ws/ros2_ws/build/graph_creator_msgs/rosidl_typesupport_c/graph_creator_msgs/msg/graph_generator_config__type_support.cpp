...
static const _GraphGeneratorConfig_type_support_symbol_names_t _GraphGeneratorConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, msg, GraphGeneratorConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_creator_msgs, msg, GraphGeneratorConfig)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_creator_msgs, msg, GraphGeneratorConfig)() {
  return &::graph_creator_msgs::msg::rosidl_typesupport_c::GraphGeneratorConfig_message_type_support_handle;
}
