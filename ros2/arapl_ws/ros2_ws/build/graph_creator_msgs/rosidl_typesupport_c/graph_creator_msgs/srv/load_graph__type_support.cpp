...
static const _LoadGraph_Request_type_support_symbol_names_t _LoadGraph_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, LoadGraph_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_creator_msgs, srv, LoadGraph_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_creator_msgs, srv, LoadGraph_Request)() {
  return &::graph_creator_msgs::srv::rosidl_typesupport_c::LoadGraph_Request_message_type_support_handle;
}
...
static const _LoadGraph_Response_type_support_symbol_names_t _LoadGraph_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, LoadGraph_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_creator_msgs, srv, LoadGraph_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_creator_msgs, srv, LoadGraph_Response)() {
  return &::graph_creator_msgs::srv::rosidl_typesupport_c::LoadGraph_Response_message_type_support_handle;
}
...
static const _LoadGraph_type_support_symbol_names_t _LoadGraph_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, LoadGraph)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_creator_msgs, srv, LoadGraph)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, graph_creator_msgs, srv, LoadGraph)() {
  return &::graph_creator_msgs::srv::rosidl_typesupport_c::LoadGraph_service_type_support_handle;
}
