...
#include "graph_creator_msgs/srv/detail/set_bool__rosidl_typesupport_fastrtps_c.h"
...
using _SetBool_Request__ros_msg_type = graph_creator_msgs__srv__SetBool_Request;
...
size_t get_serialized_size_graph_creator_msgs__srv__SetBool_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetBool_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_creator_msgs__srv__SetBool_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_graph_creator_msgs
size_t max_serialized_size_graph_creator_msgs__srv__SetBool_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_creator_msgs__srv__SetBool_Request;
    is_plain =
      (
...
static size_t _SetBool_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_creator_msgs__srv__SetBool_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, SetBool_Request)() {
...
using _SetBool_Response__ros_msg_type = graph_creator_msgs__srv__SetBool_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_graph_creator_msgs
size_t get_serialized_size_graph_creator_msgs__srv__SetBool_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetBool_Response__ros_msg_type * ros_message = static_cast<const _SetBool_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_creator_msgs__srv__SetBool_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_graph_creator_msgs
size_t max_serialized_size_graph_creator_msgs__srv__SetBool_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = graph_creator_msgs__srv__SetBool_Response;
    is_plain =
      (
...
static size_t _SetBool_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_creator_msgs__srv__SetBool_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, SetBool_Response)() {
...
// already included above
// #include "graph_creator_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "graph_creator_msgs/srv/set_bool.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, srv, SetBool)() {
