...
#include "graph_creator_msgs/msg/detail/edge_direction_creation_type__rosidl_typesupport_fastrtps_c.h"
...
using _EdgeDirectionCreationType__ros_msg_type = graph_creator_msgs__msg__EdgeDirectionCreationType;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EdgeDirectionCreationType__ros_msg_type * ros_message = static_cast<const _EdgeDirectionCreationType__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _EdgeDirectionCreationType__ros_msg_type * ros_message = static_cast<_EdgeDirectionCreationType__ros_msg_type *>(untyped_ros_message);
  // Field name: direction_type
  {
    cdr >> ros_message->direction_type;
  }
...
static uint32_t _EdgeDirectionCreationType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_creator_msgs__msg__EdgeDirectionCreationType(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_creator_msgs__msg__EdgeDirectionCreationType;
    is_plain =
      (
...
static size_t _EdgeDirectionCreationType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_creator_msgs__msg__EdgeDirectionCreationType(
...
static message_type_support_callbacks_t __callbacks_EdgeDirectionCreationType = {
...
static rosidl_message_type_support_t _EdgeDirectionCreationType__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EdgeDirectionCreationType,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_creator_msgs, msg, EdgeDirectionCreationType)() {
  return &_EdgeDirectionCreationType__type_support;
}
