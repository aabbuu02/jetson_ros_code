...
#include "graph_msgs/msg/detail/property__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const graph_msgs::msg::Property & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  graph_msgs::msg::Property & ros_message)
{
  // Member: key
  cdr >> ros_message.key;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_msgs::msg::Property;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const graph_msgs::msg::Property *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<graph_msgs::msg::Property *>(
    untyped_ros_message);
...
{
  return &graph_msgs::msg::typesupport_fastrtps_cpp::_Property__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, graph_msgs, msg, Property)() {
  return &graph_msgs::msg::typesupport_fastrtps_cpp::_Property__handle;
}
