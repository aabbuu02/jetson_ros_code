...
graph_msgs__srv__GetGraph_Request__create()
{
  ...
  graph_msgs__srv__GetGraph_Request * msg = (graph_msgs__srv__GetGraph_Request *)allocator.allocate(sizeof(graph_msgs__srv__GetGraph_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(graph_msgs__srv__GetGraph_Request));
  bool success = graph_msgs__srv__GetGraph_Request__init(msg);
  if (!success) {
...
graph_msgs__srv__GetGraph_Request__destroy(graph_msgs__srv__GetGraph_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    graph_msgs__srv__GetGraph_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
graph_msgs__srv__GetGraph_Request__Sequence__init(graph_msgs__srv__GetGraph_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  graph_msgs__srv__GetGraph_Request * data = NULL;

  if (size) {
    data = (graph_msgs__srv__GetGraph_Request *)allocator.zero_allocate(size, sizeof(graph_msgs__srv__GetGraph_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = graph_msgs__srv__GetGraph_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        graph_msgs__srv__GetGraph_Request__fini(&data[i - 1]);
      }
...
graph_msgs__srv__GetGraph_Request__Sequence__fini(graph_msgs__srv__GetGraph_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      graph_msgs__srv__GetGraph_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  graph_msgs__srv__GetGraph_Request__Sequence * array = (graph_msgs__srv__GetGraph_Request__Sequence *)allocator.allocate(sizeof(graph_msgs__srv__GetGraph_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = graph_msgs__srv__GetGraph_Request__Sequence__init(array, size);
  if (!success) {
...
graph_msgs__srv__GetGraph_Request__Sequence__destroy(graph_msgs__srv__GetGraph_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    graph_msgs__srv__GetGraph_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
graph_msgs__srv__GetGraph_Request__Sequence__are_equal(const graph_msgs__srv__GetGraph_Request__Sequence * lhs, const graph_msgs__srv__GetGraph_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!graph_msgs__srv__GetGraph_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  graph_msgs__srv__GetGraph_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(graph_msgs__srv__GetGraph_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    graph_msgs__srv__GetGraph_Request * data =
      (graph_msgs__srv__GetGraph_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!graph_msgs__srv__GetGraph_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          graph_msgs__srv__GetGraph_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!graph_msgs__srv__GetGraph_Request__copy(
...
graph_msgs__srv__GetGraph_Response__init(graph_msgs__srv__GetGraph_Response * msg)
{
  ...
  if (!graph_msgs__msg__Graph__init(&msg->graph)) {
    graph_msgs__srv__GetGraph_Response__fini(msg);
    return false;
  }
  // result
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  graph_msgs__srv__GetGraph_Response * msg = (graph_msgs__srv__GetGraph_Response *)allocator.allocate(sizeof(graph_msgs__srv__GetGraph_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(graph_msgs__srv__GetGraph_Response));
  bool success = graph_msgs__srv__GetGraph_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
graph_msgs__srv__GetGraph_Response__Sequence__init(graph_msgs__srv__GetGraph_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  graph_msgs__srv__GetGraph_Response * data = NULL;

  if (size) {
    data = (graph_msgs__srv__GetGraph_Response *)allocator.zero_allocate(size, sizeof(graph_msgs__srv__GetGraph_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = graph_msgs__srv__GetGraph_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        graph_msgs__srv__GetGraph_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
graph_msgs__srv__GetGraph_Response__Sequence__fini(graph_msgs__srv__GetGraph_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      graph_msgs__srv__GetGraph_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  graph_msgs__srv__GetGraph_Response__Sequence * array = (graph_msgs__srv__GetGraph_Response__Sequence *)allocator.allocate(sizeof(graph_msgs__srv__GetGraph_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = graph_msgs__srv__GetGraph_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
graph_msgs__srv__GetGraph_Response__Sequence__destroy(graph_msgs__srv__GetGraph_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    graph_msgs__srv__GetGraph_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
graph_msgs__srv__GetGraph_Response__Sequence__are_equal(const graph_msgs__srv__GetGraph_Response__Sequence * lhs, const graph_msgs__srv__GetGraph_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!graph_msgs__srv__GetGraph_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  graph_msgs__srv__GetGraph_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(graph_msgs__srv__GetGraph_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    graph_msgs__srv__GetGraph_Response * data =
      (graph_msgs__srv__GetGraph_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!graph_msgs__srv__GetGraph_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          graph_msgs__srv__GetGraph_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!graph_msgs__srv__GetGraph_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
