...
{
  new (message_memory) graph_msgs::srv::LoadGraph_Request(_init);
}

void LoadGraph_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<graph_msgs::srv::LoadGraph_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadGraph_Request_message_member_array[1] = {
  {
    ...
    offsetof(graph_msgs::srv::LoadGraph_Request, graph_url),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadGraph_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(graph_msgs::srv::LoadGraph_Request),
...
{
  return &::graph_msgs::srv::rosidl_typesupport_introspection_cpp::LoadGraph_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_msgs, srv, LoadGraph_Request)() {
  return &::graph_msgs::srv::rosidl_typesupport_introspection_cpp::LoadGraph_Request_message_type_support_handle;
}
...
void LoadGraph_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) graph_msgs::srv::LoadGraph_Response(_init);
}

void LoadGraph_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<graph_msgs::srv::LoadGraph_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadGraph_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(graph_msgs::srv::LoadGraph_Response, graph),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(graph_msgs::srv::LoadGraph_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadGraph_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(graph_msgs::srv::LoadGraph_Response),
...
{
  return &::graph_msgs::srv::rosidl_typesupport_introspection_cpp::LoadGraph_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_msgs, srv, LoadGraph_Response)() {
  return &::graph_msgs::srv::rosidl_typesupport_introspection_cpp::LoadGraph_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers LoadGraph_service_members = {
  ...
  // see get_service_type_support_handle<graph_msgs::srv::LoadGraph>()
...
get_service_type_support_handle<graph_msgs::srv::LoadGraph>()
{
  ...
  auto service_type_support =
    &::graph_msgs::srv::rosidl_typesupport_introspection_cpp::LoadGraph_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, graph_msgs, srv, LoadGraph)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<graph_msgs::srv::LoadGraph>();
}
