...
static const _GetGraphPlan_Request_type_support_symbol_names_t _GetGraphPlan_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, GetGraphPlan_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, GetGraphPlan_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, GetGraphPlan_Request)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::GetGraphPlan_Request_message_type_support_handle;
}
...
static const _GetGraphPlan_Response_type_support_symbol_names_t _GetGraphPlan_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, GetGraphPlan_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, GetGraphPlan_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, GetGraphPlan_Response)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::GetGraphPlan_Response_message_type_support_handle;
}
...
static const _GetGraphPlan_type_support_symbol_names_t _GetGraphPlan_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, GetGraphPlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, GetGraphPlan)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, GetGraphPlan)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::GetGraphPlan_service_type_support_handle;
}
