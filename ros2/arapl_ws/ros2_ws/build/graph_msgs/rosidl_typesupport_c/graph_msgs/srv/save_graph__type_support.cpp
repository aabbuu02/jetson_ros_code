...
static const _SaveGraph_Request_type_support_symbol_names_t _SaveGraph_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, SaveGraph_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, SaveGraph_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, SaveGraph_Request)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::SaveGraph_Request_message_type_support_handle;
}
...
static const _SaveGraph_Response_type_support_symbol_names_t _SaveGraph_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, SaveGraph_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, SaveGraph_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, SaveGraph_Response)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::SaveGraph_Response_message_type_support_handle;
}
...
static const _SaveGraph_type_support_symbol_names_t _SaveGraph_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, srv, SaveGraph)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, graph_msgs, srv, SaveGraph)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, graph_msgs, srv, SaveGraph)() {
  return &::graph_msgs::srv::rosidl_typesupport_c::SaveGraph_service_type_support_handle;
}
