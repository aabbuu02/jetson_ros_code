...
bool graph_msgs__msg__property__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("graph_msgs.msg._property.Property", full_classname_dest, 33) == 0);
  }
  graph_msgs__msg__Property * ros_message = _ros_message;
  {  // key
...
PyObject * graph_msgs__msg__property__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("graph_msgs.msg._property");
