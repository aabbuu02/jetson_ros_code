...
bool graph_msgs__msg__vertex__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("graph_msgs.msg._vertex.Vertex", full_classname_dest, 29) == 0);
  }
  graph_msgs__msg__Vertex * ros_message = _ros_message;
  {  // id
  ...
  {  // ignore_orientation
    PyObject * field = PyObject_GetAttrString(_pymsg, "ignore_orientation");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->ignore_orientation = (Py_True == field);
    Py_DECREF(field);
  }
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of Vertex */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("graph_msgs.msg._vertex");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vertex");
  ...
  {  // ignore_orientation
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->ignore_orientation ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ignore_orientation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
