...
#include "graph_msgs/msg/detail/graph__rosidl_typesupport_fastrtps_c.h"
...
#include "graph_msgs/msg/detail/edge__functions.h"  // edges
#include "graph_msgs/msg/detail/graph_meta_data__functions.h"  // meta_data
#include "graph_msgs/msg/detail/property__functions.h"  // properties
#include "graph_msgs/msg/detail/vertex__functions.h"  // vertices
...
size_t get_serialized_size_graph_msgs__msg__GraphMetaData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_graph_msgs__msg__GraphMetaData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, graph_msgs, msg, GraphMetaData)();
...
using _Graph__ros_msg_type = graph_msgs__msg__Graph;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: meta_data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, graph_msgs, msg, GraphMetaData
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->meta_data, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: edges
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, graph_msgs, msg, Edge
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: vertices
  {
    ...
    if (ros_message->vertices.data) {
      graph_msgs__msg__Vertex__Sequence__fini(&ros_message->vertices);
    }
  ...
  // Field name: edges
  {
    ...
    if (ros_message->edges.data) {
      graph_msgs__msg__Edge__Sequence__fini(&ros_message->edges);
    }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_graph_msgs__msg__GraphMetaData(
  ...
  // field.name edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_graph_msgs__msg__Edge(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name properties
...
static uint32_t _Graph__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_msgs__msg__Graph(
  ...
  size_t current_alignment)
{
  ...
  // member: meta_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_graph_msgs__msg__GraphMetaData(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_graph_msgs__msg__Edge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = graph_msgs__msg__Graph;
    is_plain =
      (
...
static size_t _Graph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_msgs__msg__Graph(
