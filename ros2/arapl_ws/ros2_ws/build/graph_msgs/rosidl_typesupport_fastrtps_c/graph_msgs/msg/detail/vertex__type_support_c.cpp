...
#include "graph_msgs/msg/detail/vertex__rosidl_typesupport_fastrtps_c.h"
...
using _Vertex__ros_msg_type = graph_msgs__msg__Vertex;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Vertex__ros_msg_type * ros_message = static_cast<const _Vertex__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Vertex__ros_msg_type * ros_message = static_cast<_Vertex__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _Vertex__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_msgs__msg__Vertex(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_msgs__msg__Vertex;
    is_plain =
      (
...
static size_t _Vertex__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_msgs__msg__Vertex(
...
static message_type_support_callbacks_t __callbacks_Vertex = {
  "graph_msgs::msg",
  "Vertex",
...
static rosidl_message_type_support_t _Vertex__type_support = {
