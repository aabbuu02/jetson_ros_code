...
#include "graph_msgs/msg/detail/property__rosidl_typesupport_fastrtps_c.h"
...
using _Property__ros_msg_type = graph_msgs__msg__Property;
...
static uint32_t _Property__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_graph_msgs__msg__Property(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = graph_msgs__msg__Property;
    is_plain =
      (
...
static size_t _Property__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_graph_msgs__msg__Property(
