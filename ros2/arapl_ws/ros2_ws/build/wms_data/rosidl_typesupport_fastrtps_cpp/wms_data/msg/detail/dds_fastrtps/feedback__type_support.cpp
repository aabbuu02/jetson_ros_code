...
#include "wms_data/msg/detail/feedback__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wms_data::msg::Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wms_data::msg::Feedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wms_data::msg::Feedback *>(
    untyped_ros_message);
...
{
  return &wms_data::msg::typesupport_fastrtps_cpp::_Feedback__handle;
}
